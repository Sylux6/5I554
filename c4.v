...
Definition swap_program : com (* := YOUR DEFINITION HERE *). Admitted.
...
Theorem hoare_if1 : (* YOUR SPECIFICATION HERE *) False. Admitted.
...
(** The final lecture will be an exam-like session -- ie., 3 hours of
exercises -- followed by a Q&A session. _You_ will be driving the
discussion so come prepared. Another reason to come prepared: you'll
have to submit your Coq developments at the end of the 3 hours and it
will account for your final grade. *)
